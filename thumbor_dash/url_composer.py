...
from thumbor_dash.crypto import ThumborDashCryptoURL
...
def get_parser():
    ...
    parser.add_option(
        ...
        dest="dashauth",
        action="append",
        help="Dashauth parameters, e.g requester(<requesterId>).",
    )
    parser.add_option(
        "",
        "--filters",
...
def main(arguments=None):
    ...
    crypto = ThumborDashCryptoURL(key=security_key)
