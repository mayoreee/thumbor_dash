...
class ContextTestCase(TestCase):
    ...
    def test_can_create_context_with_importer():
        ...
        ctx = ThumborDashContext(config=cfg, importer=importer)
    ...
    def test_can_config_define_app_class():
        ...
        importer = Importer(cfg)
        ctx = ThumborDashContext(config=cfg, importer=importer, server=server)
...
class RequestParametersTestCase(TestCase):
    ...
    def test_can_create_request_parameters():
        params = ThumborDashRequestParameters()
        ...
        expect(params.dashauth).to_be_null()
    ...
    def test_can_get_params_with_trim():
        params = ThumborDashRequestParameters(trim="trim")
    ...
    def test_can_get_params_with_trim_with_custom_pos():
        params = ThumborDashRequestParameters(trim="trim:bottom-right:10")
    ...
    def test_can_get_orig_dimensions():
        params = ThumborDashRequestParameters(width="orig", height="orig",)
        expect(params.width).to_equal("orig")
        expect(params.height).to_equal("orig")

    @staticmethod
    def test_can_add_filters():
        params = ThumborDashRequestParameters(filters=["a", "b"])
        expect(params.filters).to_length(2)

    @staticmethod
    def test_can_add_focal_points():
        params = ThumborDashRequestParameters(focal_points=["a", "b"])
    ...
    def test_can_get_params_from_request():
        ...
        params = ThumborDashRequestParameters(request=request, image="/test.jpg")
...
class ContextImporterTestCase(TestCase):
    ...
    def test_can_create_context_importer():
        ...
        ctx_importer = ThumborDashContextImporter(ctx, importer)
