...
## handler.
## Defaults to: True
USE_CUSTOM_ERROR_HANDLING = {{ USE_CUSTOM_ERROR_HANDLING | default(True) }}
...
## Defaults to: 'thumbor_dash.app.ThumborDashServiceApp'
APP_CLASS = '{{ APP_CLASS | default('thumbor_dash.app.ThumborDashServiceApp') }}'

################################################################################

################################### User Moderation ####################################
# time between requests in minutes
REQUEST_TIME_LIMIT = {{ REQUEST_TIME_LIMIT | default(1) }} # time between requests in minutes

# total number of times a requester can violate the time limit before ban
USAGE_VIOLATION_LIMIT = {{ USAGE_VIOLATION_LIMIT | default(5) }} 

# requester ban duration in minutes
BAN_DURATION = {{ BAN_DURATION | default(10) }} 
